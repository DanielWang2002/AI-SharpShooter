...
def mouseMoveTo(ori_x, ori_y, tx, ty):
    k = Keys()
    k.directMouse(tx - ori_x, ty - ori_y)

def mouseClick(btn = 'L'):
    k = Keys()
    if btn == 'L':
        ...
        k.directMouse(buttons=k.mouse_rb_press)
        sleep(0.001)
        k.directMouse(buttons=k.mouse_rb_release)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        ori_x, ori_y = pag.position().x, pag.position().y

        tx, ty = 1200, 700

        keys.directMouse(tx - ori_x, ty - ori_y)
    ...
    #         if x > 960:
    #             if y > 540:
    #                 keys.directMouse(x - 960, y - 540)
    #             else:
    #                 keys.directMouse(x - 960, 540 - y)
    #         else:
    #             if y > 540:
    #                 keys.directMouse(960 - x, y - 540)
    #             else:
    #                 keys.directMouse(960 - x, 540 - y)
